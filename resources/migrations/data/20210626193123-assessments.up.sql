...
--;;
insert into assessment (name, release, assessment_table, type, short_name, scale) values
('NWEA MAP - Mathematics', 'MAP 2021', 'assessment_map_v1', 'math', 'MAP', 'RIT Score'),
('NWEA MAP - ELA', 'MAP 2021', 'assessment_map_v1', 'ela', 'Forward', 'Fs'),
('PreACT 8/9', 'PreACT 8/9', 'assessment_preact_v1', 'general', 'PreACT', 'Points'),
('Forward - Mathematics', 'Forward - Mathematics', 'assessment_forward_math_v1', 'math', 'MAP', 'RIT Score'),
('Forward - ELA', 'Forward - ELA', 'assessment_forward_ela_v1', 'ela', 'Forward', 'Fs');
--;;
